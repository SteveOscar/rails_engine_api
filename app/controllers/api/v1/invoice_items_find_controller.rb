class Api::V1::InvoiceItemsFindController < Api::ApiController
  ...
  def show
    ...
    respond_with InvoiceItem.find_by(unit_price: params[:unit_price].to_f * 100) if params[:unit_price]
  ...
  def index
    ...
    respond_with InvoiceItem.where(unit_price: params[:unit_price].to_f * 100) if params[:unit_price]
